...
namespace Evrinoma\AddressBundle\Tests\Functional\Controller;

use Evrinoma\AddressBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.address.test.functional.action.address';
    ...
    {
        return [FixtureInterface::ADDRESS_FIXTURES];
    }
}
